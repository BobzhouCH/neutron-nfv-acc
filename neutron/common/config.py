...
core_opts = [
    ...
    cfg.BoolOpt('rate_limiting', default=False,
                help=_('Enable floatingip rate limiting feature or not')),
    cfg.IntOpt('default_north_south_bandwidth', default=4,
               help=_('Default bandwidth for floatingip traffic (mbit)')),
]
