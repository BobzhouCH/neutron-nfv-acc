...
class IptablesFirewallDriver(firewall.FirewallDriver):
    ...
    def _metadata_rule(self, ipv4_rules, ipv6_rules):
        ipv4_rules += [comment_rule('-p tcp -d 169.254.169.254/32 '
                                    '-m state --state NEW -j RETURN',
                                    comment=ic.METADATA_PROXY)]
        # TODO ipv6 rules
    ...
    def _add_fixed_egress_rules(self, port, ipv4_iptables_rules,
        ...
        self._metadata_rule(ipv4_iptables_rules, [])
