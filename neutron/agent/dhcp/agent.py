...
#begin:added by jimin3,bug-78251,2016-12-7
from neutron.agent.common import utils as agent_utils
#end: added by jimin3,bug-78251,2016-12-7
...
class DhcpAgent(manager.Manager):
    ...
    def init_host(self):
        #begin: modified by jimin3,bug-78251, 2016-12-12
        #self.sync_state()
        pass
        #end: modified by jimin3,bug-78251, 2016-12-12
...
class DhcpAgentWithStateReport(DhcpAgent):
    ...
    def _report_state(self):
        try:
            ...
            #begin:added by jimin3,bug-78251,2016-12-7
            if agent_status == constants.AGENT_DUPLICATED:
                LOG.info(_LI('Agent is duplicated. May need to exit'))
    ...
    def after_start(self):
        ...
        while self.duplicate_agent_times <= (cfg.CONF.AGENT.agent_down_time / cfg.CONF.AGENT.report_interval + 1):
            if 'start_flag' in self.agent_state:
                eventlet.sleep(self.conf.AGENT.report_interval)
            else:
                break
        if self.duplicate_agent_times > (cfg.CONF.AGENT.agent_down_time / cfg.CONF.AGENT.report_interval + 1):
            raise agent_utils.DuplicatedAgent()
        #end:added by jimin3,bug-78251,2016-12-7
        LOG.info(_LI("DHCP agent started"))
