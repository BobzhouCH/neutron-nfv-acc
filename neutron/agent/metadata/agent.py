...
#begin: modified by jimin3, bug-78254,2016-12-7. Deleted by jimin3,bug-82197,2017-1-3
from neutron._i18n import _, _LE, _LW
#end: modified by jimin3, bug-78254,2016-12-7.  Deleted by jimin3,bug-82197,2017-1-3
...
class UnixDomainMetadataProxy(object):
    ...
    def _report_state(self):
        try:
            ...
            #        self.heartbeat.stop()
            #    return
            #end: Deleted by jimin3,bug-82197,2017-1-3
