...
from neutron.extensions import domain_quota_sync
...
class QuotaSetsController(wsgi.Controller):
    ...
    def update(self, request, id, body=None):
        ...
        project_quotas = self._get_quotas(request, id)
        domain_quota_sync.check_valid(request.context,
                                      id,
                                      body[self._resource_name].copy(),
                                      project_quotas)
